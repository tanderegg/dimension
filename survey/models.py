...
class Player(BasePlayer):
    ...
    q_risk2 = models.CharField(initial=None,
                                ...
                                widget=widgets.RadioSelect())
    q_risk3 = models.CharField(initial=None,
                                ...
                                widget=widgets.RadioSelect())
    q_risk4 = models.CharField(initial=None,
                                choices=['1. Not at all willing to take risks', '2', '3', '4', '5. Very willing to take risks'],
                                verbose_name='How willing are you to take risks in your life, in general?',
                                widget=widgets.RadioSelect())

    q_subjNum1 = models.CharField(initial=None,
                                choices=['1. Not at all good', '2', '3', '4', '5', '6. Extremely good'],
                                verbose_name='How good are you at working with fractions?',
                                widget=widgets.RadioSelect())
    q_subjNum2 = models.CharField(initial=None,
                                choices=['1. Not at all good', '2', '3', '4', '5', '6. Extremely good'],
                                verbose_name='How good are you at working with percentages?',
                                widget=widgets.RadioSelect())
    q_subjNum3 = models.CharField(initial=None,
                                choices=['1. Not at all good', '2', '3', '4', '5', '6. Extremely good'],
                                verbose_name='How good are you at calculating a 15% tip?',
                                widget=widgets.RadioSelect())
    q_subjNum4 = models.CharField(initial=None,
                                choices=['1. Not at all good', '2', '3', '4', '5', '6. Extremely good'],
                                verbose_name='How good are you at figuring out how much a shirt will cost if it is 25% off?',
                                widget=widgets.RadioSelect())
    q_subjNum5 = models.CharField(initial=None,
                                ...
                                widget=widgets.RadioSelect())
    q_subjNum6 = models.CharField(initial=None,
                                choices=['1. Always prefer words', '2', '3', '4', '5', '6. Always prefer numbers'],
                                ...
                                widget=widgets.RadioSelect())
    q_subjNum7 = models.CharField(initial=None,
                                choices=['1. Always prefer percentages', '2', '3', '4', '5', '6. Always prefer words'],
                                ...
                                widget=widgets.RadioSelect())
    q_subjNum8 = models.CharField(initial=None,
                                choices=['1. Never', '2', '3', '4', '5', '6. Very often'],
                                verbose_name='How often do you find numerical information to be useful?',
                                widget=widgets.RadioSelect())

    q_objNum1 = models.PositiveIntegerField(verbose_name='Imagine that we have a fair, 6-sided die (for example, from a board game or a casino craps table).  Imagine we now roll it 1000 times.  Out of 1000 rolls, how many times do you think the die would come up even (numbers 2, 4, or 6)?',
                                        min=0,
                                        max=10000,
                                        initial=None)
    q_objNum2 = models.PositiveIntegerField(verbose_name='In the Big Bucks Lottery, the chance of winning a $10.00 prize is 1%.  What is your best guess about how many people would win a $10.00 prize if 1000 people each buy a single ticket to Big Bucks?',
                                        min=0,
                                        max=10000,
                                        initial=None)
    q_objNum3 = models.DecimalField(verbose_name='In the Acme Publishing Sweepstakes, the chance of winning a car is 1 in 1000.  What percentage of tickets to Acme Publishing Sweepstakes win a car?',
                                        max=10000,
                                        max_digits=5,
                                        decimal_places=3,
                                        initial=None)
    ...
    q_experience = models.CharField(initial=None,
                                ...
                                widget=widgets.RadioSelect())
    q_english = models.CharField(initial=None,
    ...
    q_futureStudies = models.CharField(initial=None,
